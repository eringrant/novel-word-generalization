...
if not os.path.exists(os.path.join(data_dir, 'stimuli')):
    os.makedirs(os.path.join(data_dir, 'stimuli'))
if not os.path.exists(os.path.join(data_dir, 'features')):
    os.makedirs(os.path.join(data_dir, 'features'))
...
simple_training_set['one example'] = {}
simple_training_set['three subordinate examples'] = {}
simple_training_set['three basic-level examples'] = {}
simple_training_set['three superordinate examples'] = {}

simple_training_set['one example']['subord_01'] = ['instance_feature_01', 'subord_feature_01', 'basic_feature_01', 'super_feature_01']

simple_training_set['three subordinate examples']['subord_01'] = ['instance_feature_01', 'subord_feature_01', 'basic_feature_01', 'super_feature_01']
simple_training_set['three subordinate examples']['subord_02'] = ['instance_feature_02', 'subord_feature_01', 'basic_feature_01', 'super_feature_01']
simple_training_set['three subordinate examples']['subord_03'] = ['instance_feature_03', 'subord_feature_01', 'basic_feature_01', 'super_feature_01']

simple_training_set['three basic-level examples']['basic_01'] = ['instance_feature_01', 'subord_feature_01', 'basic_feature_01', 'super_feature_01']
simple_training_set['three basic-level examples']['basic_02'] = ['instance_feature_04', 'subord_feature_02', 'basic_feature_01', 'super_feature_01']
simple_training_set['three basic-level examples']['basic_03'] = ['instance_feature_05', 'subord_feature_03', 'basic_feature_01', 'super_feature_01']

simple_training_set['three superordinate examples']['super_01'] = ['instance_feature_01', 'subord_feature_01', 'basic_feature_01', 'super_feature_01']
simple_training_set['three superordinate examples']['super_02'] = ['instance_feature_06', 'subord_feature_04', 'basic_feature_02', 'super_feature_01']
simple_training_set['three superordinate examples']['super_03'] = ['instance_feature_07', 'subord_feature_05', 'basic_feature_03', 'super_feature_01']

simple_test_set = {}

simple_test_set['subordinate matches'] = {}
simple_test_set['basic-level matches'] = {}
simple_test_set['superordinate matches'] = {}

simple_test_set['subordinate matches']['subord_01'] = ['instance_feature_08', 'subord_feature_01', 'basic_feature_01', 'super_feature_01']
simple_test_set['subordinate matches']['subord_02'] = ['instance_feature_09', 'subord_feature_01', 'basic_feature_01', 'super_feature_01']

simple_test_set['basic-level matches']['basic_01'] = ['instance_feature_10', 'subord_feature_06', 'basic_feature_01', 'super_feature_01']
simple_test_set['basic-level matches']['basic_02'] = ['instance_feature_11', 'subord_feature_07', 'basic_feature_01', 'super_feature_01']

simple_test_set['superordinate matches']['super_01'] = ['instance_feature_12', 'subord_feature_08', 'basic_feature_04', 'super_feature_01']
simple_test_set['superordinate matches']['super_02'] = ['instance_feature_13', 'subord_feature_09', 'basic_feature_05', 'super_feature_01']
simple_test_set['superordinate matches']['super_03'] = ['instance_feature_14', 'subord_feature_10', 'basic_feature_06', 'super_feature_01']
simple_test_set['superordinate matches']['super_04'] = ['instance_feature_15', 'subord_feature_11', 'basic_feature_07', 'super_feature_01']

simple = {}
simple['training set'] = simple_training_set
simple['test set'] = simple_test_set

json.dump(simple, open(os.path.join(data_dir, 'stimuli', 'simple_stimuli.json'), 'w'), indent=4, separators=(',', ': '))


simple_features = {}

for feature in ['instance_feature_{num:02d}'.format(num=i) for i in range(1, 16)]:
    simple_features[feature] = 'instance'
for feature in ['subord_feature_{num:02d}'.format(num=i) for i in range(1, 12)]:
    simple_features[feature] = 'subord'
for feature in ['basic_feature_{num:02d}'.format(num=i) for i in range(1, 8)]:
    simple_features[feature] = 'basic'
for feature in ['super_feature_{num:02d}'.format(num=i) for i in range(1, 2)]:
    simple_features[feature] = 'super'

json.dump(simple_features, open(os.path.join(data_dir, 'features', 'simple_features.json'), 'w'), indent=4, separators=(',', ': '), sort_keys=True)
...
json.dump(containers, open(os.path.join(data_dir, 'stimuli', 'container_stimuli.json'), 'w'), indent=4, separators=(',', ': '))


container_features = {}

for letter in ['A', 'B', 'C']:
    for feature in ['instance_feature_' + letter + '{num:02d}'.format(num=i) for i in range(1, 16)]:
        container_features[feature] = 'instance'
    for feature in ['subord_feature_' + letter + '{num:02d}'.format(num=i) for i in range(1, 12)]:
        container_features[feature] = 'subord'
    for feature in ['basic_feature_' + letter + '{num:02d}'.format(num=i) for i in range(1, 8)]:
        container_features[feature] = 'basic'
    for feature in ['super_feature_' + letter + '{num:02d}'.format(num=i) for i in range(1, 2)]:
        container_features[feature] = 'super'

json.dump(container_features, open(os.path.join(data_dir, 'features', 'container_features.json'), 'w'), indent=4, separators=(',', ': '), sort_keys=True)
...
json.dump(clothing, open(os.path.join(data_dir, 'stimuli', 'clothing_stimuli.json'), 'w'), indent=4, separators=(',', ': '))
...
for letter in ['A', 'B']:
    for feature in ['instance_feature_' + letter + '{num:02d}'.format(num=i) for i in range(1, 16)]:
        clothing_features[feature] = 'instance'
    for feature in ['subord_feature_' + letter + '{num:02d}'.format(num=i) for i in range(1, 12)]:
        clothing_features[feature] = 'subord'
    for feature in ['basic_feature_' + letter + '{num:02d}'.format(num=i) for i in range(1, 8)]:
        clothing_features[feature] = 'basic'
    for feature in ['super_feature_' + letter + '{num:02d}'.format(num=i) for i in range(1, 2)]:
        clothing_features[feature] = 'super'

json.dump(clothing_features, open(os.path.join(data_dir, 'features', 'clothing_features.json'), 'w'), indent=4, separators=(',', ': '), sort_keys=True)
...
json.dump(seats, open(os.path.join(data_dir, 'stimuli', 'seat_stimuli.json'), 'w'), indent=4, separators=(',', ': '))
...
for feature in ['subord_feature_{num:02d}'.format(num=i) for i in range(1, 12)]:
    seat_features[feature] = 'subord'
for feature in ['basic_feature_{num:02d}'.format(num=i) for i in range(1, 8)]:
    seat_features[feature] = 'basic'
for feature in ['super_feature_{num:02d}'.format(num=i) for i in range(1, 2)]:
    seat_features[feature] = 'super'

json.dump(seat_features, open(os.path.join(data_dir, 'features', 'seat_features.json'), 'w'), indent=4, separators=(',', ': '), sort_keys=True)
...
json.dump(xt_vegetables_sets, open(os.path.join(data_dir, 'stimuli', 'xt_vegetable_stimuli.json'), 'w'), indent=4, separators=(',', ': '))


xt_vegetable_features = {}

for feature in ['UNIQ{num:02d}'.format(num=i) for i in range(16, 31)]:
    xt_vegetable_features[feature] = 'instance'
for feature in ['UNIQ{num:02d}'.format(num=i) for i in range(16, 31)]:
    xt_vegetable_features[feature] = 'instance'
    ...
    for feature in xt_vegetables[obj]:
        if not feature.startswith('UNIQ'):
            ...
            if level in range(31, 35):
                ...
                xt_vegetable_features[feature] = 'subord'
            elif level in range(3, 21):
                xt_vegetable_features[feature] = 'basic'
            elif level in range(1, 3):
                xt_vegetable_features[feature] = 'super'

json.dump(xt_vegetable_features, open(os.path.join(data_dir, 'features', 'xt_vegetable_features.json'), 'w'), indent=4, separators=(',', ': '), sort_keys=True)
...
json.dump(xt_vehicles_sets, open(os.path.join(data_dir, 'stimuli', 'xt_vehicle_stimuli.json'), 'w'), indent=4, separators=(',', ': '))
    ...
    for feature in xt_vehicles[obj]:
        if not feature.startswith('UNIQ'):
            ...
            if level in range(26, 36):
                ...
                xt_vehicle_features[feature] = 'subord'
            elif level in range(2, 12):
                xt_vehicle_features[feature] = 'basic'
            elif level in range(1, 2):
                xt_vehicle_features[feature] = 'super'

json.dump(xt_vehicle_features, open(os.path.join(data_dir, 'features', 'xt_vehicle_features.json'), 'w'), indent=4, separators=(',', ': '), sort_keys=True)
...
json.dump(xt_animals_sets, open(os.path.join(data_dir, 'stimuli', 'xt_animal_stimuli.json'), 'w'), indent=4, separators=(',', ': '))

xt_animal_features = {}

for feature in ['UNIQ{num:02d}'.format(num=i) for i in range(16, 31)]:
    xt_animal_features[feature] = 'instance'
for feature in ['UNIQ{num:02d}'.format(num=i) for i in range(16, 31)]:
    xt_animal_features[feature] = 'instance'
    ...
    for feature in xt_animals[obj]:
        if not feature.startswith('UNIQ'):
            ...
            if level in range(36, 41):
                ...
                xt_animal_features[feature] = 'subord'
            elif level in range(3, 21):
                xt_animal_features[feature] = 'basic'
            elif level in range(1, 3):
                xt_animal_features[feature] = 'super'

json.dump(xt_animal_features, open(os.path.join(data_dir, 'features', 'xt_animal_features.json'), 'w'), indent=4, separators=(',', ': '), sort_keys=True)
