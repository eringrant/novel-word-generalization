...
teach_1X3 = [reps['dalmatian0']] * 30
teach_3Xsub = []
teach_3Xbas = []
for (k,v) in items.items():
    if k.startswith('dalmatian'):
        teach_3Xsub.append(reps[k])
    if k.startswith('dalmatian1') or k.startswith('poodle1') or k.startswith('pug1'):
        teach_3Xbas.append(reps[k])       
print len(teach_3Xsub)
print len(teach_3Xbas) 
